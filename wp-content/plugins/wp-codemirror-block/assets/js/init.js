...
(function ($, wpcm, CodeMirror) {
  ...
  wpcm.codeMirrorInit = function (id, code, options) {
    ...
    if (options.showPanel !== undefined && options.showPanel === false) {
      ...
      wpcm.panelOptions.showPanel === true
    ) {
      editor
        .getWrapperElement()
  ...
  wpcm.addPanel = function (editor, options) {
    ...
    if (options.languageLabel == "no") {
      ...
      language.className += options.modeName
        ? " " + options.modeName.toLowerCase()
        : "";
      ...
      language.className += options.modeName
        ? " " + options.modeName.toLowerCase()
        : "";
    } else if (window.wpcm.panelOptions.languageLabel == "language") {
      language.textContent = options.language;
      language.className = "language " + options.language.toLowerCase();
      language.className += options.modeName
        ? " " + options.modeName.toLowerCase()
        : "";
    } else if (window.wpcm.panelOptions.languageLabel == "file") {
      language.textContent = options.fileName
        ? options.fileName
        : options.language;
      language.className = "language " + options.language.toLowerCase();
  ...
  wpcm.setFullScreen = function () {
    ...
    if (el.classList.contains("maximize")) {
      ...
      el.closest(".CodeMirror").classList.remove(
  ...
  wpcm.copyToClipboard = function () {
    ...
    if (window.clipboardData) {
      ...
      try {
        ...
        var notice = successful ? "Copied to clipboard" : "Can not copied";
      } catch (err) {
